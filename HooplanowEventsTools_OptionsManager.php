...
class HooplanowEventsTools_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'hooplanow-events-tools'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'hooplanow-events-tools'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'hooplanow-events-tools'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'hooplanow-events-tools'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'hooplanow-events-tools');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'hooplanow-events-tools'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'hooplanow-events-tools');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'hooplanow-events-tools'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'hooplanow-events-tools') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'hooplanow-events-tools');
            case 'false':
                return __('false', 'hooplanow-events-tools');

            case 'Administrator':
                return __('Administrator', 'hooplanow-events-tools');
            case 'Editor':
                return __('Editor', 'hooplanow-events-tools');
            case 'Author':
                return __('Author', 'hooplanow-events-tools');
            case 'Contributor':
                return __('Contributor', 'hooplanow-events-tools');
            case 'Subscriber':
                return __('Subscriber', 'hooplanow-events-tools');
            case 'Anyone':
                return __('Anyone', 'hooplanow-events-tools');
        }
        return $optionValue;
    }
